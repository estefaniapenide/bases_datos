DROP DATABASE IF EXISTS entradas_unipersonales_varios_tipos;
CREATE DATABASE entradas_unipersonales_varios_tipos;
USE entradas_unipersonales_varios_tipos;
-- Está aun por hacer bien (esto es solo una copia de la otra versión)
...
INSERT INTO tipos_entradas (zona, aforo, pvp) VALUES ("A", 1, 1);
