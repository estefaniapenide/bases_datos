...
CREATE TABLE sedes (
    ...
    telefono2 BIGINT,
    provincia VARCHAR(30) NOT NULL COMMENT "Podría ser un enum o una tabla, según las circunstancias"
);

CREATE TABLE departamentos (
	num SMALLINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    nombre VARCHAR(255) NOT NULL UNIQUE,
    fcreacion DATE NOT NULL DEFAULT (CURDATE()),
    prima DECIMAL(10,2) NOT NULL,
    director SMALLINT UNSIGNED UNIQUE, -- El índice UNIQUE permite garantizar una relación 1:1
